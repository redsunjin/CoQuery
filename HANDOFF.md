...
- `python3 sql_cli/tests/test_core.py` passes with 35 baseline tests
...
Next: keep the PostgreSQL probe harness stable and keep broader backend/provider/JPA tracks outside the core branch unless explicitly accepted

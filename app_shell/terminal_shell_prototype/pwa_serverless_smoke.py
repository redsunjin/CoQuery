...
def main() -> int:
    ...
    require(APP / "index.html", '<script src="./dialect-learning.js"></script>')
    require(APP / "service-worker.js", 'const CACHE_NAME = "coquery-pwa-v6"')
    ...
    require(APP / "service-worker.js", '"./practice-result-explain.js"')
    require(APP / "service-worker.js", '"./practice-result-explain.css"')
    require(APP / "service-worker.js", '"./practice-result-views.js"')
    require(APP / "service-worker.js", '"./practice-result-views.css"')
    require(APP / "service-worker.js", '"./dialect-learning.js"')
    ...
    require(APP / "pwa-runtime.js", 'script.src = "./practice-result-views.js"')
    require(APP / "pwa-runtime.js", 'style.href = "./practice-result-views.css"')
